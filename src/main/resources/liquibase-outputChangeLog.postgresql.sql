...
-- changeset kakatya:1674731453977-1
...
-- changeset kakatya:1674731453977-2
...
-- changeset kakatya:1674731453977-3
...
-- changeset kakatya:1674731453977-4
...
-- changeset kakatya:1674731453977-5
...
-- changeset kakatya:1674731453977-6
...
-- changeset kakatya:1674731453977-7
...
-- changeset kakatya:1674731453977-8
...
-- changeset kakatya:1674731453977-9
...
-- changeset kakatya:1674731453977-10
...
-- changeset kakatya:1674731453977-11
...
-- changeset kakatya:1674731453977-12
CREATE TABLE "credit" ("credit_id" BIGINT NOT NULL, "amount" numeric(19, 2), "credit_status" VARCHAR(255), "insurance_enable" BOOLEAN, "monthly_payment" numeric(19, 2), "payment_schedule" JSONB, "psk" numeric(19, 2), "rate" numeric(19, 2), "salary_client" BOOLEAN, "term" INTEGER, CONSTRAINT "credit_pkey" PRIMARY KEY ("credit_id"));

-- changeset kakatya:1674731453977-13
...
-- changeset kakatya:1674731453977-14
